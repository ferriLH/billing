  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  <section class="content-header">
		  ...
		  <ol class="breadcrumb">
			  <li><a href="<?php if ($this->session->userdata('isLogin') == "partner"){ echo base_url('home');}else{echo base_url('admin');}?>"><i class="fa fa-home"></i></a></li>
			  ...
			  <div class="col-md-3">
				  ...
				  <div class="box box-primary">
					  <div class="box-body box-profile">
						  <img class="profile-user-img img-responsive " src="<?php echo base_url()?>assets/images/user.png"alt="User profile picture">
