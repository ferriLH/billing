...
<div class="content-wrapper">
	...
	<section class="content container-fluid">
		<div class="box box-primary">
			...
			<!-- /.box-header -->
			<form role="form" action="<?php echo base_url('pencipta/edit/auth/').$edit[0]['id']?>" method="post">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="namaPencipta" id="namaPencipta" placeholder="Nama Pencipta" value="<?php echo $edit[0]['namaPencipta']?>" required>
					</div>
					<div class="form-group">
						<label for="noTelp">No Telpon</label>
						<input type="number" class="form-control" name="noTelp" id="noTelp" placeholder="No Telpon" value="<?php echo $edit[0]['noTelp']?>">
					</div>
					<div class="form-group">
